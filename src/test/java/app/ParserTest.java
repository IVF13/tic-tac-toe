...
public class ParserTest {
    ...
    void parserJSONTest() {
        ...
        Player player1 = new Player(1, "Ivan", GameConstants.X);
        Player player2 = new Player(2, "Roman", GameConstants.O);
        ...
        assertEquals("[" + GameConstants.DRAW + "]", Parser.gameResult.toString());
